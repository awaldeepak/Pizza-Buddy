...
var statuses = document.querySelectorAll('.status-line'); // To create a small for displaying time of a perticular step completed

var time = document.createElement('small'); // Change single order status
...
socket.on('orderUpdatedFromServer', function (data) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkpizza_buddy"] = self["webpackChunkpizza_buddy"] || [];
